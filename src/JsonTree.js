...
const defaultProps = {
    ...
    onDeltaUpdate: ({
        type, keyPath, deep, key, newValue, oldValue,
    }) => {
    },
...
const createParsingFunction = (allowFunctionEvaluation) => (isEditMode, keyPath, deep, name, rawValue) => parse(rawValue, allowFunctionEvaluation);
...
class JsonTree extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        let { onSubmitValueParserWasGenerated } = this.state;
        if (
